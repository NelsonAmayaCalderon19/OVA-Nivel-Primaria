    ...
    <body>
        <div id="contenido">
            <div id="encabezado">
                ...
                <div id="navegacion">
                   <a href="contenido_secundaria3.jsp" target="frame" id="anterior"><i class="fa fa-caret-left" id="caretant"></i> Anterior</a> <input id="campo" type="text" value="4/18" disabled=""/><a href="contenido_secundaria5.jsp" target="frame" id="siguiente">Siguiente <i class="fa fa-caret-right" id="caret"></i></a>
                </div>
                </div>
            <div id="cont">
                <div id="titulo">
                    <div id="titulos">
                        <h1 id="titulo_video">Contenedor Amarillo</h1>
                    </div>  
                </div>
                
                <div id="camp">
                    <div id="camp3">
                    <img class="imgen" src="images/caneca_amarilla.png" alt="">
                    </div>
                    <div id="camp2">
      ...
      <script src="js/contenido_secundaria4.js" type="text/javascript"></script>
    </body>
</html>
