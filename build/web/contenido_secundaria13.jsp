...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/style_contenido_secundaria_13.css">
        <title>Contenido 13</title>
    </head>
    <body>
        <div id="contenido">
            <div id="encabezado">
                ...
                <div id="navegacion">
                   <a href="contenido_secundaria12.jsp" target="frame" id="anterior"><i class="fa fa-caret-left" id="caretant"></i> Anterior</a> <input id="campo" type="text" value="13/18" disabled=""/><a href="contenido_secundaria14.jsp" target="frame" id="siguiente">Siguiente <i class="fa fa-caret-right" id="caret"></i></a>
                </div>
                </div>
            <div id="conten">
                <div id="conten2">
        ...
        <script src="js/contenido_secundaria13.js" type="text/javascript"></script>
    </body>
</html>
