...
<html>
	...
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
        ...
        <link rel="stylesheet" type="text/css" href="css/style_conten_secundaria_3.css">
    ...
    <body>
        <div id="contenido">
            ...
            <div id="cont">
                ...
                <div id="camp">
                    <div id="camp1">
                        <p id="texto">El contenedor de color azul es usado para alojar todos los residuos como papel y cartón, 
