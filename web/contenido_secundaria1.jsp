...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/style_contenido_secundaria_1.css">
    ...
    <body>
        <div id="contenido">
            <div id="encabezado">
                ...
                <div id="navegacion">
                   <a href="" target="frame" id="anterior"><i class="fa fa-caret-left" id="caretant"></i> Anterior</a> <input id="campo" type="text" value="1/18" disabled=""/><a href="contenido_secundaria2.jsp" target="frame" id="siguiente">Siguiente <i class="fa fa-caret-right" id="caret"></i></a>
                </div>
                </div>
            <div id="conten">
        ...
        <script src="js/contenido_secundaria1.js" type="text/javascript"></script>
    </body>
</html>
